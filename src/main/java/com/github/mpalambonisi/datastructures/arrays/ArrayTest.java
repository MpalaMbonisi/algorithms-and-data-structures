package com.github.mpalambonisi.datastructures.arrays;
...
public class ArrayTest {
    public void testRemoveElement(){
        ...
        int val1 = 1;
        int newLength1 = Array.removeElement(nums1, val1);
        ...
        int val2 = 6;
        int newLength2 = Array.removeElement(nums2, val2);
        ...
        int[] nums3 = {-1, -2, -3, -4, -5};
        int val3 = -1;
        int newLength3 = Array.removeElement(nums3, val3);
        ...
        int[] nums4 = {};
        int val4 = 1;
        int newLength4 = Array.removeElement(nums4, val4);
        ...
        int[] nums5 = {1, 1, 1, 1, 1};
        int val5 = 1;
        int newLength5 = Array.removeElement(nums5, val5);
    ...
    public void removeDuplicatesTest(){
        ...
        int newLength1 = Array.removeDuplicates(nums1);
        ...
        int[] nums2 = {1, 1, 2};
        int newLength2 = Array.removeDuplicates(nums2);
        ...
        int newLength3 = Array.removeDuplicates(nums3);
        ...
        int[] nums4 = {};
        int newLength4 = Array.removeDuplicates(nums4);
        ...
        int[] nums5 = {1, 1, 1, 1, 1};
        int newLength5 = Array.removeDuplicates(nums5);
    ...
    public void maxSubArrayTest(){
        ...
        int result1 = Array.maxSubarray(inputCase1);
        ...
        int result2 = Array.maxSubarray(inputCase2);
        ...
        int result3 = Array.maxSubarray(inputCase3);
        ...
        int result4 = Array.maxSubarray(inputCase4);
        ...
        int result5 = Array.maxSubarray(inputCase5);
